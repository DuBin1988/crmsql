...
from
	t_sellinggas
where 
	f_deliverydate>='2016-0{month}-01' and f_deliverydate<='2016-0{month}-30'
	and f_districtname like '{districtname}%' 
group by
	SUBSTRING(CONVERT(varchar,f_deliverydate,120),1,11),f_gasprice,f_stair1price
order by 
